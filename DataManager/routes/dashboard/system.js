...
router.get('/dockerConPerHost', function(req, res, body) {
	...
	let query = '{"size":0,"query":{"match_all":{}},"aggs":{"alert_per_time":{"terms":{"field":"beat.name.keyword","order":{"_count":"desc"},"size":5},"aggs":{"count":{"cardinality":{"field":"docker.container.id.keyword"}}}}},"post_filter":{' + common.getTimeRange(req.query) + '}}';
